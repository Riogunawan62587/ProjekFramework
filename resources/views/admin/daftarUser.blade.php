  ...
  <div class="container-fluid container-application">
    ...
    <div class="sidenav" id="sidenav-main">
      ...
      <div class="nav-application clearfix">
        ...
        <a href="/admin/pengguna" class="btn btn-square text-sm active">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-3">
                      <div class="custom-control custom-checkbox">
                        <input type="radio" class="custom-control-input" name="project-privacy" id="radio-project-3"
                          checked>
                        <label class="custom-control-label form-control-label text-muted"
                ...
                <div class="form-group">
                  <div>
                    ...
                    <input type="file" name="file-1[]" id="file-1" class="custom-input-file"
