          ...
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body text-center">
                ...
                <h5 class="h2"><a href="card-listing.html#">Nasi Gudeg</a></h5>
                <h5 class="h6"><a href="card-listing.html#">Rp 35.000</a></h5>
                <span class="clearfix"></span>
                <span class="badge badge-pill badge-success">Aktif</span>
              </div>
              <div class="card-footer">
                <div class="actions d-flex justify-content-between px-4">
                  <a href="card-listing.html#" class="action-item">
                    <i class="far fa-pencil"></i>
                  </a>
                  <a href="card-listing.html#" class="action-item text-danger">
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body text-center">
                ...
                <h5 class="h2"><a href="card-listing.html#">Nasi Rames</a></h5>
                <h5 class="h6"><a href="card-listing.html#">Rp 25.000</a></h5>
                <span class="clearfix"></span>
                <span class="badge badge-pill badge-success">Aktif</span>
              </div>
              <div class="card-footer">
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body text-center">
                ...
                <h5 class="h2"><a href="card-listing.html#">Pecel Madiun</a></h5>
                <h5 class="h6"><a href="card-listing.html#">Rp 25.000</a></h5>
                <span class="clearfix"></span>
                <span class="badge badge-pill badge-success">Aktif</span>
              </div>
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body text-center">
                ...
                <h5 class="h2"><a href="card-listing.html#">Mie Goreng</a></h5>
                <h5 class="h6"><a href="card-listing.html#">Rp 25.000</a></h5>
                <span class="clearfix"></span>
                <span class="badge badge-pill badge-success">Aktif</span>
              </div>
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body text-center">
                ...
                <h5 class="h2"><a href="card-listing.html#">Ayam Bakar</a></h5>
                <h5 class="h6"><a href="card-listing.html#">Rp 35.000</a></h5>
                <span class="clearfix"></span>
                <span class="badge badge-pill badge-success">Aktif</span>
              </div>
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body text-center">
                ...
                <h5 class="h2"><a href="card-listing.html#">Roti Bakar</a></h5>
                <h5 class="h6"><a href="card-listing.html#">Rp 15.000</a></h5>
                <span class="clearfix"></span>
                <span class="badge badge-pill badge-success">Aktif</span>
              </div>
              <div class="card-footer">
          ...
          <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="card hover-shadow-lg">
              ...
              <div class="card-body text-center">
                ...
                <h5 class="h2"><a href="card-listing.html#">Bubur Ayam</a></h5>
                <h5 class="h6"><a href="card-listing.html#">Rp 20.000</a></h5>
                <span class="clearfix"></span>
                <span class="badge badge-pill badge-success">Aktif</span>
              </div>
              <div class="card-footer">
