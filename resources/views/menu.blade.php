			...
			<div class="row">
				<div class="col">
					...
					<nav class="section_menu__nav">
						<ul>
							<li class="active">
								<a href="menu.html#menu_images" data-filter=".mains">Mains</a>
							</li>
							<li>
								<a href="menu.html#menu_images" data-filter=".lunch">Lunch</a>
							</li>
							<li>
								<a href="menu.html#menu_images" data-filter=".dinner">Dinner</a>
							</li>
							<li>
								<a href="menu.html#menu_images" data-filter=".drinks">Drinks</a>
							</li>
						</ul>
					</nav>
