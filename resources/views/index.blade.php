				...
				<div class="row align-items-center">
					<div class="col">
						...
						<h2 class="section__preheading section_welcome__preheading text-center text-muted">
							<span class="text-primary">Restoran
						</h2>
						...
						<div class="text-center">
							<a href="index.html#section_reservation" class="btn btn-primary text-white">
								Buat Reservasi
							</a>
						</div>
			...
			<div class="row">
				<div class="col">
					...
					<p class="section__subheading text-center">
						Disajikan oleh juru masak terbaik dengan cita rasa Nusantara dan Dunia!
					</p>
			...
			<div class="row">
				<div class="col">
					...
					<nav class="section_menu__nav">
						<ul>
							<li class="active">
								<a href="index.html#menu_images" data-filter=".foods">Makanan</a>
							</li>
							<li>
								<a href="index.html#menu_images" data-filter=".drinks">Minuman</a>
							</li>
						</ul>
					</nav>
