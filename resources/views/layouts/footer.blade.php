    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        ...
        <div class="section_footer__open">
          <div class="section_footer__open__days">Senin - Jumat</div>
          <div class="section_footer__open__time">10.00 WIB - 21.00 WIB</div>
        </div>
        <div class="section_footer__open">
          <div class="section_footer__open__days">Sabtu - Minggu</div>
          <div class="section_footer__open__time">11.00 WIB - 23.00 WIB</div>
        </div>
